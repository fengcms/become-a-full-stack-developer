...
下一篇（[注册登录全流程实现](https://blog.csdn.net/fungleo/article/details/164396193)）我们顺着认证往下走，把"注册登录全流程"完整实现一遍：注册为什么强制 `member`、密码怎么哈希、登录怎么发双令牌、以及那个"首个 admin 怎么来"的死锁怎么解。
