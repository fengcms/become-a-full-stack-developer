...
下一篇（[接口文档自动化：让 OpenAPI 与代码不脱节](https://blog.csdn.net/fungleo/article/details/164584149)）我们聊"接口文档自动化"：如何让 OpenAPI 契约和代码不脱节，以及那套"双门校验"是怎么守住契约的。
