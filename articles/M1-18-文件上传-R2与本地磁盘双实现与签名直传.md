...
![成为全栈·Node 后端篇·文件上传：R2 / 本地磁盘双实现与签名直传](https://i-blog.csdnimg.cn/direct/cef1aeda2a54430daa3c752962c7677b.png)
...
![一层适配层伺候两个后端](https://i-blog.csdnimg.cn/direct/6cd641ef8f01470483cc4b347fb98214.png)
...
![内容寻址去重](https://i-blog.csdnimg.cn/direct/5e1aca816581428a93956584557f3060.png)
...
![删除的引用计数护栏](https://i-blog.csdnimg.cn/direct/3d25aa67fd084b2cbe36b8ddc4af3b2f.png)
...
下一篇（[全文搜索：从 LIKE 到全文索引](https://blog.csdn.net/fungleo/article/details/164582848)）我们聊"全文搜索"：什么时候 `LIKE` 够用、中文分词有多现实、以及什么时候该上 Meilisearch / ES 这类专用引擎。
