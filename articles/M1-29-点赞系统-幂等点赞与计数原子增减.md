...
顺带，这和[阅读量：时间桶去重与原子计数](https://blog.csdn.net/fungleo/article/details/164493891)的阅读量 `viewCount` 是同一个思路：把"高频展示的聚合值"冗余成一个字段，写时维护，读时直取。两处设计同源，可见"冗余计数"是本项目的通用手艺。
...
把点赞和[阅读量：时间桶去重与原子计数](https://blog.csdn.net/fungleo/article/details/164493891)的阅读量放一起看，能看清两种"防作弊"思路的差异：
