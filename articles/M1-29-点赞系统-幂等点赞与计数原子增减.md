...
![成为全栈·Node 后端篇·点赞系统：幂等点赞与计数原子增减](https://i-blog.csdnimg.cn/direct/c91e62a807e749fdbbc4ba0f76cf841c.png)
...
![幂等点赞](https://i-blog.csdnimg.cn/direct/7ca48ce7f54c4be9999cfdda18b6e650.png)
...
![冗余计数](https://i-blog.csdnimg.cn/direct/cb805ad708494137a6984f67ae96dda2.png)
...
顺带，这和[阅读量：时间桶去重与原子计数](https://blog.csdn.net/fungleo/article/details/164973883)的阅读量 `viewCount` 是同一个思路：把"高频展示的聚合值"冗余成一个字段，写时维护，读时直取。两处设计同源，可见"冗余计数"是本项目的通用手艺。
...
把点赞和[阅读量：时间桶去重与原子计数](https://blog.csdn.net/fungleo/article/details/164973883)的阅读量放一起看，能看清两种"防作弊"思路的差异：
...
下一篇（[通知系统：事件消费与已读态管理](https://blog.csdn.net/fungleo/article/details/165293002)）我们聊"通知系统"：文章发布、评论通过这类事件，怎么变成用户收得到的站内信，以及通知和前面点赞/评论的联动。
