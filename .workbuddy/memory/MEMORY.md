...
- **发布进度（2026-09-22）**：M0 全 8 篇、**M1 全 31 篇（2026-09-16 收官）**、**M2-01~13 已发布**（M2-14/15 待发）。`{{LINK:}}` 占位在**已发布范围内零残留**。
- **待最终全量更新清单**（本地源已改、等系列发完统一重发）：`M1-02`、`M1-06`、`M1-07`、`M1-09`、`M1-14`、`M1-17`、`M1-18`、`M1-19`、`M1-20`、`M1-21`、`M1-22`、`M1-23`、`M1-24`、`M1-25`、`M1-26`、`M1-27`、`M1-28`、`M1-29`、`M1-30`、`M1-31`、`M2-02`、`M2-03`、`M2-05`、`M2-06`、`M2-09`、`M2-11`、`M0-03`（含 09-19 坏链 9 处、09-22 错链 2 处）。⚠️ 此清单**不完整**，见「发布维护 SOP」小节末条。
- **SOP-C 审计基线（2026-09-22）**：正文唯一 ID 52 / 索引 460，幽灵链 0、错链 0。存疑未改：`M2-07` 文案多写「与权限模型」但目标（M1-12 认证方案）正确。
