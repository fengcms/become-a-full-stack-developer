...
- **发布进度（2026-09-23）**：M0 全 8 篇、**M1 全 31 篇（2026-09-16 收官）**、**M2-01~15 已发布**（M2-14=`166353905`、M2-15=`166354291`，均 2026-09-22 发布；M2-16/17 待发）。`{{LINK:}}` 占位在**已发布范围内零残留**。
...
- **SOP-C 审计基线（2026-09-23）**：正文唯一 ID 53 / 索引 451，幽灵链 0、错链 0（严格口径）。存疑未改：`M2-07` 文案多写「与权限模型」但目标（M1-12 认证方案）正确。
